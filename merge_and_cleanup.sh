...
# # Ensure the current branch is not the same as the temporary branch
# if [ "$CURRENT_BRANCH" == "$TEMP_BRANCH" ]; then
#     echo "You are already on the branch $CURRENT_BRANCH. Please switch to another branch to merge."
#     exit 1
# fi
